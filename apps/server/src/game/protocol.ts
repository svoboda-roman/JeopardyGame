...
export interface FinalJeopardyView {
  ...
  results: { playerId: string; wager: number; answer: string; verdict: 'correct' | 'incorrect' | 'no_answer' }[]
}
...
export type ClientToServer =
  ...
  | { type: 'fj_judge'; playerId: string; verdict: 'correct' | 'incorrect' | 'no_answer' }
